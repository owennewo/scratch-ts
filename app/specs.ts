...
export class Specs {
	...
	public static GetVar:string = "readVariable";
	public static SetVar:string = "setVar:to:";
	public static ChangeVar:string = "changeVar:by:";
	public static GetList:string = "contentsOfList:";
	public static Call:string = "call";
	public static ProcedureDef:string = "procDef";
	public static GetParam:string = "getParam";

	public static MotionCategory:number = 1;
	public static LooksCategory:number = 2;
	public static EventsCategory:number = 5;
	public static ControlCategory:number = 6;
	public static OperatorsCategory:number = 8;
	public static DataCategory:number = 9;
	public static MyBlocksCategory:number = 10;
	...
	public static IconNamed(name:string):any {
