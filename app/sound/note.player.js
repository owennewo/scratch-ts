System.register(["./sound.decoder"], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            NotePlayer = (function (_super) {
                __extends(NotePlayer, _super);
                function NotePlayer(wavFileData, originalPitch, loopStart, loopEnd, env) {
                    _super.call(this, wavFileData);
                    ...
                    if ((loopStart >= 0) && (loopStart < this.endOffset)) {
                        ...
                        if ((loopEnd > 0) && (loopEnd <= this.endOffset))
                            this.endOffset = loopEnd;
                ...
                NotePlayer.prototype.setDuration = function (secs) {
                    ...
                    if (!this.isLooped)
                        this.samplesRemaining = Math.min(this.samplesRemaining, this.endOffset / this.stepSize);
                ...
                NotePlayer.prototype.interpolatedSample = function () {
                    ...
                    if (this.samplesRemaining < 1000)
                        sample *= (this.samplesRemaining / 1000.0); // relaase phease
                    this.updateEnvelope();
                ...
                return NotePlayer;
            })(sound_decoder_1.SoundDecoder);
            exports_1("NotePlayer", NotePlayer);
        }
    }
});
//# sourceMappingURL=note.player.js.map