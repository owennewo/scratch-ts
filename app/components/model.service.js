System.register(["../io/project.io", "angular2/core", "angular2/http"], function(exports_1) {
    ...
    var project_io_1, core_1, http_1, core_2;
    var ModelService;
    return {
        setters:[
            function (project_io_1_1) {
                project_io_1 = project_io_1_1;
            },
            function (core_1_1) {
                core_1 = core_1_1;
                core_2 = core_1_1;
            ...
            ModelService = (function () {
                ...
                ModelService.prototype.loadProject = function (projectId) {
                    ...
                    this.http.get(projectUrl).subscribe(function (res) {
                        ...
                        var projectIO = new project_io_1.ProjectIO();
